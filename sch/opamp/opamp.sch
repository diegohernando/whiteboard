...
C {ngspice_get_value.sym} 1290 -330 0 0 {name=r2 node=i(@M.X1.XM1.msky130_fd_pr__pfet_01v8[id])
descr="I= "}
...
descr="I= "}
C {ngspice_get_value.sym} 1570 -330 0 0 {name=r11 node=i(@M.X1.XM2.msky130_fd_pr__pfet_01v8[id])
descr="I= "}
...
descr="I= "}
C {ngspice_get_value.sym} 1290 -300 0 0 {name=r15 node=@M.X1.XM1.msky130_fd_pr__pfet_01v8[gm]
descr="gm= "}
C {launcher.sym} 1000 -170 0 0 {name=h1
descr=Annotate 
tclcommand="ngspice::annotate"}
C {ngspice_get_value.sym} 1570 -300 0 0 {name=r16 node=@M.X1.XM2.msky130_fd_pr__pfet_01v8[gm]
descr="gm= "}
