...
.control
  ...
  *setplot noise1
  ...
  print inoise_total
  print onoise_total
  print onoise_total.m.x1.xm1.msky130_fd_pr__pfet_01v8.1overf
  print onoise_total.m.x1.xm1.msky130_fd_pr__pfet_01v8.id
...
C {opamp/opamp.sym} 1240 -340 0 0 {name=x1}
C {ngspice_probe.sym} 1390 -370 0 0 {name=r1}
